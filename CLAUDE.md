...
Seedfy is a comprehensive garden management application built with Flutter, featuring AI-powered
plant recognition and chat assistance using NVIDIA's NIM APIs, Firebase integration, and Supabase
for farm data management.
...
- **AI Services**: NVIDIA NIM APIs (microsoft/phi-3-vision-128k-instruct,
...
- This dual approach leverages Firebase's real-time capabilities for AI features while using
  Supabase's PostgreSQL for complex relational farm data
...
3. **NVIDIA AI Configuration**:
    - API key is hardcoded in `nvidia_ai_service.dart` (should be moved to environment variables in
      production)
