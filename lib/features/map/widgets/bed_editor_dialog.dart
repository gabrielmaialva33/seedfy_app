...
class _BedEditorDialogState extends State<BedEditorDialog> {
  ...
  int _calculateQuantity() {
    ...
    final bedArea = double.parse(_widthController.text) *
      ...
      content: Column(
        ...
        children: [
          ...
          Slider(
            ...
            divisions: ((_selectedCrop!.cycleDays * 1.5) -
                    (_selectedCrop!.cycleDays * 0.5))
                .round(),
            label:
                '${_customCycleDays ?? _selectedCrop!.cycleDays} ${isPortuguese ? "dias" : "days"}',
            onChanged: (value) {
              setState(() {
