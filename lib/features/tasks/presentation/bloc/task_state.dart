...
class TaskState with _$TaskState {
  ...
  const factory TaskState.pendingTasksLoaded(List<Task> tasks) =
      _PendingTasksLoaded;

  const factory TaskState.todayTasksLoaded(List<Task> tasks) =
      _TodayTasksLoaded;

  const factory TaskState.overdueTasksLoaded(List<Task> tasks) =
      _OverdueTasksLoaded;
  ...
  const factory TaskState.statsLoaded(Map<String, dynamic> stats) =
      _StatsLoaded;
