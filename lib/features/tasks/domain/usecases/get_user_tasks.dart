...
class GetUserTasks implements UseCase<List<entities.Task>, NoParams> {
...
class GetPendingTasks implements UseCase<List<entities.Task>, NoParams> {
  final TaskRepository repository;
...
class GetTodayTasks implements UseCase<List<entities.Task>, NoParams> {
  final TaskRepository repository;
...
class GetOverdueTasks implements UseCase<List<entities.Task>, NoParams> {
  final TaskRepository repository;
